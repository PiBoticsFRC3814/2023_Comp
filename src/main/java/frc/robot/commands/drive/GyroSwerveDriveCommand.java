...
public class GyroSwerveDriveCommand extends CommandBase {
  ...
  public GyroSwerveDriveCommand(DoubleSupplier stick_x, DoubleSupplier stick_y, DoubleSupplier stick_z, DoubleSupplier stick_z2, ADIS16470_IMU imu, GyroSwerveDrive gyroSwerveDrive) {
